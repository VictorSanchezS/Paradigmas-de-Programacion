...
int menu(){
    ...
    position(40, 10); colour(11);cout<<"[1] Registrar Enfermedad";
    position(40, 11); colour(11);cout<<"[2] Registrar Paciente";
    position(40, 12); colour(11);cout<<"[3] Buscar Enfermedad";
    position(40, 13);colour(11);cout<<"[4] Buscar Paciente";//Un bucle dentro de otro bucle
    position(40, 14);colour(11);cout<<"[5] Listar Enfermedad con Pacientes";//Seleccionar Enfermdad y que muestre la lista de Pacientes
    position(40, 15);colour(11);cout<<"[0] Salir";
    do{
...
void registrationHeaderPatient(){
    system("cls");
    position(40,3);cout << "************************";
    position(40,4);cout << "|  REGISTRAR PACIENTE  |";
    position(40,5);cout << "************************";
}
...
void emptyList(){
    system("cls");
    position(45,8); cout << "|=================================|";
    position(45,9); cout << "|\a NO HAY ENFERMEDADES REGISTRADAS |";
    position(45,10); cout<< "|=================================|";
    addDelay(2);
}
...
void headerPatients(){
    position(12,4); cout << "DNI";
    position(24,4); cout << "NOMBRES";
    position(34,4);cout << "APELLIDOS";
    position(50,4);cout << "EDAD";
    position(66,4);cout << "PESO";
    position(72,4);cout << "TALLA";
}
