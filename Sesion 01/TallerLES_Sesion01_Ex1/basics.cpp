...
int menu(){
    ...
    position(40, 10); colour(11);cout<<"[1] Registrar Equipo";
    position(40, 11); colour(11);cout<<"[2] Registrar Jugador";
    position(40, 12); colour(11);cout<<"[3] Buscar equipo de futbol";
    position(40, 13);colour(11);cout<<"[4] Listar Equipos";
    position(40, 14);colour(11);cout<<"[5] Mostrar equipos con jugadores";
